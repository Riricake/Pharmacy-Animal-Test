const screens = {
    ...
    chickenThinkingScreen: document.getElementById("chicken-thinking-screen"),
...
const questions = [
    {
        type: "info",
        text: "You wake up and the weather is good outside. You get ready and go to work as usual..."
    },
    {
        type: "question",
...
function displayQuestion(questionNumber) {
    ...
    loadingBar.src = `./assets/Q${questionNumber} progress.svg`
    ...
    if (questionData.type == "question") {
        ...
        if (questionData.manual) {
            let frame = 1

            function updateImage() {
                questionImage.src = `./assets/Q${questionNumber}_${frame}.png`
                frame = frame % 2 + 1
            }

            updateImage()

            imageAnimation = setInterval(updateImage, 500)
        } else {
            questionImage.src = `./assets/Q${questionNumber}.gif`
        }
    } else {
        questionButtons.questionButton1.style.display = "none"
        questionButtons.questionButton2.style.display = "none"
